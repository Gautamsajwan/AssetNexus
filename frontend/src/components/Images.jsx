...
function Images({ source, fileName, imageId }) {
  ...
  return (
    <div className="relative group bg-gray-800 rounded-lg overflow-hidden">
      ...
      <div className="p-[10px] w-32 h-12 flex gap-3 rounded-bl-lg absolute top-0 right-0 opacity-0 group-hover:opacity-100 group-hover:bg-gray-800/70 transition-opacity ease-in-out duration-300 z-20">
